<nav class="navbar navbar-light navbar-vertical navbar-vibrant navbar-expand-lg">
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            ...
            <div class="text-center pt-4 pb-3" >
                        <div class="avatar avatar-xl"><img class="rounded-circle" src="<?= base_url();?>template/assets/img/team/<?=$this->session->userdata("img")?>" alt="" style="
    /* border-color: #FFF; */
    border: solid 4px #fb964d;
"></div>
                        <h6 class="mt-2" style="color:#FFF;"><?=$this->session->userdata("nama")?></h6>
                        <p style="color:#DDD"><?=$this->session->userdata("jabatan")?></p>
                      </div>
              <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                <!-- <li class="nav-item">
                  <p class="navbar-vertical-label">Pages</p><a class="nav-link active" href="../pages/starter.html" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <!-- <a class="nav-link dropdown-indicator" href="#forms" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="forms">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon d-flex flex-center"><span class="fas fa-caret-right fs-0"></span></div><span class="nav-link-icon"><span data-feather="file-text"></span></span><span class="nav-link-text">Absensi Pribadi</span>
                    </div>
                  </a> -->
            ...
            <!-- <div class="navbar-vertical-footer"><a class="btn btn-link border-0 fw-semi-bold d-flex ps-0" href="<?=site_url('Login/auth_logout')?>"><span class="navbar-vertical-footer-icon" data-feather="log-out"></span><span>Settings</span></a></div> -->
          </div>
        </nav>